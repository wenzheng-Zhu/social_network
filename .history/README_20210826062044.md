...
3. 这三个需求中主要的难点是实现关注。我的做法是创建一张关系表 relationships, 比如说user1关注 user2，相当user1是主动建立一个关系，一个主动的关系，这张表里存的主要字段有两个，,那么follower_id相当于user1的id, followed_id相当于user2的id, 主要的关联关系是 
